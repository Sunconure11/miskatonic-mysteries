...
import moriyashiine.acme.common.item.consumable.ItemMilkGoat;
import moriyashiine.acme.common.item.consumable.ItemTranquilizer;
import moriyashiine.acme.common.item.misc.ItemMMBook;
...
public class ModObjects {
    ...
    public static Item necronomicon = Util.create(new ItemMMBook(), "necronomicon");
}