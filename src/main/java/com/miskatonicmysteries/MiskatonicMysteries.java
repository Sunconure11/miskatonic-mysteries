...
public class MiskatonicMysteries {
    public static final String MODID = "miskatonicmysteries", NAME = "Miskatonic Mysteries", VERSION = "1.2";
    ...
    public void initTileEntities(){
        ...
        GameRegistry.registerTileEntity(TileEntityStatue.class, new ResourceLocation(MODID, "statue"));
    }
